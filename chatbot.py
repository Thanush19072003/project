...
#PREDICT POSSIBLE SYMPTOM IN SENTENCE
def predictSym(sym,vocabb,app_tag):
    sym=preprocess_sent(sym)
    bow=np.array(bag_of_words(sym,vocabb))
...
def OHV(cl_sym,all_sym):
    ...
    for sym in cl_sym:
        ...
        return pd.DataFrame(l,colums=all_sym)
