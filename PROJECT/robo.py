...
#The jaccard_set function calculates the Jaccard similarity between two strings
def jaccard_set(str1, str2):
    ...
    # Return the Jaccard similarity as a float
...
print(DoesExist('feel pain abdominal'))
print(preprocess('my skin has some nodal eruptions'))
# Preprocess the symptom description
preprocessed_symptom = preprocess('i experience pain in my abdominal')

# Calculate syntactic similarity with all_symp_pr
similarity_score, most_similar_symptoms = syntactic_similarity(preprocessed_symptom, all_symp_pr)

# Print or use the results
print("Syntactic Similarity Score:", similarity_score)
if most_similar_symptoms:
    print("Most similar symptoms:", most_similar_symptoms)
else:
    print("No similar symptoms found.")
